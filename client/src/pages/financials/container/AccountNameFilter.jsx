...
export function AccountNameFilter({ accountNameFilter, handleAccountNameChange, options, className = "", disabled }) {
  const selectedOption = useMemo(() => options.find((o) => o.id === accountNameFilter), [options, accountNameFilter]);

  return (
    <Listbox value={accountNameFilter} onChange={handleAccountNameChange} disabled={disabled}>
