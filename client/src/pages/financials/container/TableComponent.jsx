          ...
          <tr className="">
            {columns.map((column) => (
              <th
                ...
                className="px-3 text-start text-xs font-bold uppercase cursor-pointer hover:bg-gray-100 hover:rounded-lg"
            ...
            data.map((row, index) => (
              <tr key={index} className="hover:bg-gray-100">
                {columns.map((column) => (
                  ...
                  >
                    {row[column.accessor]} {/* Assuming column.accessor matches the key in your data */}
                  </td>
                ))}
              </tr>
            ))
